...
export default async function Home() {
  ...
  try {
    recentPosts = getAllPosts('published').slice(0, 3)
  } catch {}

  return (
    <>
      {/* ============= HERO ============= */}
      <section className="relative bg-navy-950 overflow-hidden min-h-[92vh] flex flex-col">
        <video
          autoPlay
          muted
          loop
        ...
        <div className="container-editorial relative z-10 mt-auto pb-0">
          <div className="grid lg:grid-cols-12 gap-8 lg:gap-16 items-end pb-16 lg:pb-20">
            <div className="lg:col-span-7">
              <h1 className="text-white text-[2.75rem] sm:text-[3.5rem] lg:text-[4.25rem] leading-[1.02] font-display font-bold tracking-tight">
                Thoughtful Coverage<br className="hidden sm:block" />
                Strategy for What<br className="hidden sm:block" />
                Matters Most
              </h1>
            </div>
        ...
        <div className="relative z-10 border-t border-white/[0.08] bg-navy-950/40 backdrop-blur-sm">
          <div className="container-editorial py-6 lg:py-7">
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-16">
              {[
                { value: '20+', label: 'Years of Service' },
                { value: '20+', label: 'Insurance Carriers' },
                { value: '2', label: 'NC Offices' },
                { value: '17+', label: 'Coverage Types' },
              ].map((stat) => (
                <div key={stat.label} className="flex items-baseline gap-3">
                  <p className="text-3xl lg:text-4xl font-display font-bold text-white">{stat.value}</p>
        ...
        <div className="container-editorial">
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-20">
            ...
            <ScrollReveal className="lg:col-span-7" delay={100}>
              <p className="text-lg text-navy-600 leading-relaxed mb-8 max-w-2xl">
      ...
      <section className="section-padding bg-white" id="insurance">
        <div className="container-editorial">
          ...
          <ScrollReveal>
            <div className="relative overflow-hidden mb-16 h-72 lg:h-96">
              <img src="/images/AdobeStock_300395016.jpeg" alt="Family at home" className="w-full h-full object-cover" />
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-px bg-gray-200">
            {personalInsurance.map((ins, idx) => (
              <ScrollReveal key={ins.slug} delay={idx * 50}>
                <Link href={`/insurance/${ins.slug}`} className="bg-white p-8 group block h-full hover:bg-gray-50 transition-colors duration-200">
                  ...
                  <p className="text-sm text-navy-500 leading-relaxed mb-5">{ins.tagline}</p>
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-start">
            <ScrollReveal>
              <div>
                ...
                <div className="overflow-hidden mb-10 h-56 lg:h-64">
                  <img src="/images/AdobeStock_415962919.jpeg" alt="Small business owners" className="w-full h-full object-cover" />
                </div>
        ...
        <div className="container-editorial">
          ...
          <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-px bg-white/10">
            {propertyInsurance.map((ins, idx) => (
              <ScrollReveal key={ins.slug} delay={idx * 50}>
                <Link href={`/insurance/${ins.slug}`} className="bg-navy-900 p-8 hover:bg-navy-800 transition-colors duration-200 group block h-full">
                  <div className="w-11 h-11 bg-white/[0.06] text-white flex items-center justify-center mb-5">
                    {getIconByName(ins.icon)}
                  </div>
            ...
            <ScrollReveal delay={250}>
              <Link href="/quote" className="bg-white/[0.04] p-8 hover:bg-white/[0.08] transition-colors duration-200 group block h-full flex flex-col items-start justify-center">
          ...
          <div className="grid lg:grid-cols-12 gap-12 lg:gap-20 items-center">
            ...
            <ScrollReveal className="lg:col-span-7" delay={100}>
              <div className="overflow-hidden">
                <img src="/images/blackarrow-whiteville.jpg" alt="BlackArrow Insurance Whiteville office" className="w-full h-80 lg:h-[28rem] object-cover" />
              </div>
              <div className="grid grid-cols-4 gap-8 mt-8 pt-8 border-t border-gray-200">
                {[
                  ...
                  <div key={item.label}>
                    <p className="text-2xl lg:text-3xl font-display font-bold text-navy-900">{item.value}</p>
        ...
        <div className="container-editorial">
          <ScrollReveal>
            <div className="mb-12">
              ...
              <h2 className="text-3xl">Manage Your Policy</h2>
            </div>
          </ScrollReveal>
          <div className="grid sm:grid-cols-3 gap-px bg-gray-200">
            {[
              ...
              <ScrollReveal key={item.href} delay={idx * 50}>
                <Link href={item.href} className="bg-white p-8 group block h-full hover:bg-gray-50 transition-colors duration-200">
                  <div className="icon-box-navy mb-5">
