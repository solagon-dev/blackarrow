      ...
      <div className="flex flex-col gap-5 sm:flex-row sm:items-center justify-between mb-8 sm:mb-10">
          ...
          <button
            ...
            className={`px-4 py-2 text-sm font-medium transition-all duration-200 touch-manipulation ${
              !activeCategory
                ...
                : 'bg-white text-navy-600 hover:text-navy-900 hover:bg-gray-100 border border-gray-200'
            }`}
          >
            All
          </button>
        ...
        <div className="relative w-full sm:w-72">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 text-sm border border-gray-200 bg-white text-navy-900 placeholder:text-navy-600 focus:border-navy-900 focus:ring-0 focus:outline-none transition-colors"
          />
        </div>
      </div>
