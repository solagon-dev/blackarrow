...
export function IconAnchor({ className = 'w-6 h-6' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M12 21V9m0 12c-3.866 0-7-1.79-7-4m7 4c3.866 0 7-1.79 7-4M12 9a3 3 0 100-6 3 3 0 000 6zm0 0v12M5 17H3m18 0h-2" />
    </svg>
  )
}
...
export function IconWrench({ className = 'w-6 h-6' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M11.42 15.17l-5.7 5.7a2.426 2.426 0 01-3.43-3.43l5.7-5.7M19.577 4.423a3 3 0 00-4.242 0l-2.829 2.829a3 3 0 000 4.242l.708.708a3 3 0 004.242 0l2.829-2.829a3 3 0 000-4.242l-.708-.708z" />
    </svg>
  )
}

export function IconBriefcase({ className = 'w-6 h-6' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function IconKey({ className = 'w-6 h-6' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
...
export function IconHardhat({ className = 'w-6 h-6' }: { className?: string }) {
  return (
    <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
      <path strokeLinecap="round" strokeLinejoin="round" d="M4.5 21h15M12 3v3m0 0a6 6 0 016 6v3H6v-3a6 6 0 016-6zm-7.5 9h15M6 15v3m12-3v3" />
    </svg>
  )
}
...
export function getIconByName(name: string, className = 'w-6 h-6') {
