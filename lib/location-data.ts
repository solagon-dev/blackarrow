...
export const locationPages: LocationPage[] = [
  {
    ...
    stateAbbr: 'NC',
    seoTitle: 'Insurance in Whiteville, NC — Compare 20+ Carriers',
    seoDescription: 'Insurance companies in Whiteville, NC: BlackArrow Insurance is the independent agency comparing home, auto, business, and flood insurance from 20+ carriers. Free quote.',
  ...
  },
  {
    ...
    state: 'North Carolina',
    stateAbbr: 'NC',
    seoTitle: 'Insurance Companies in Wilmington, NC — Compare 20+ Carriers',
    seoDescription: 'Business, home, auto, and flood insurance in Wilmington, NC. BlackArrow Insurance compares quotes from 20+ carriers — including coastal specialists. Get a free quote.',
